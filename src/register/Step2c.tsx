...
class Step2c extends React.PureComponent<IProps, IState> {
  constructor(props: IProps) {
    super(props);

    this.state = {
      quarantineDays: this.props.quarantineDays
    }
  }
  ...
  render() {
    ...
    return (
      <div id="step2c" className="content">
        <Container>
          <Row>
            <Col sm md xs lg={8}>
              <header>
                <h1>
                  <FormattedMessage id="app.register.step2a.title"
                    defaultMessage="Diga-nos um pouco mais sobre os sintomas"
                    description="Register Step 2a Title"/>
                  </h1>
                <p className="step">
          ...
          <Row>
            <Col>
              <p>
                <FormattedMessage id="app.register.question.symptoms1"
                  defaultMessage="Selecione os sintomas que você possui no momento:"
                  description="Question Symptoms at moment"/>
              </p>
            </Col>
          </Row>
          <Row>
...
export default connector(Step2c);